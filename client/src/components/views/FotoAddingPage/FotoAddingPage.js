...
import { Form, Icon, Input, Button, Switch, Checkbox, DatePicker, Select, Typography } from 'antd';
...
function FotoAddingPage(props) {
    ...
    const [authorValue, setAuthorValue] = useState("Hannes a");
    const [copyrightSourceValue, setCopyrightSourceValue] = useState("Hannes c");
